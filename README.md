...
Version `1.0.0` accepts exact path, numeric ID, or display-name matches; it deliberately
...
Version `1.0.0` can compare two saved bundles without network access:
...
Version `1.0.0` can summarize two to fifty independent bundles without network access:
...
Version 1.0.0 retains the frozen non-overlapping CLI process-status map: 0 success, 1 known
