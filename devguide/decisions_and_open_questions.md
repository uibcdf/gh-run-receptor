...
| Product portability | Runtime core and profiles are repository-agnostic; MolSysSuite identities remain fixtures, hosted evidence, or explicit client configuration | External public workflows joined the pre-1.0 corpus; UIBCDF-specific release/guide tooling is not product behavior |
