...
| Phase 3: embedded Action | 15% | 0% | First composite implementation passes offline tests; credit waits for hosted cross-platform and released-source evidence |
...
implementation credit at this checkpoint is **69% toward 1.0**. This is not a schedule
