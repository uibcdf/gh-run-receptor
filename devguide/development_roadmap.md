...
| Phase 2: rules and profiles | 20% | 19% | Initial native/noarch Conda, CI, documentation, and release interpretations plus repeated-failure grouping, strict trusted exact-match configuration, local discovery, non-overwriting `init`, safe projection of a known action-internal Conda publisher, and default-branch adoption across eight additional clients are tested; structured hidden matrices, richer rules, and external release verification remain |
