...
| --- | ---: | ---: | --- |
| Phase 0: corpus and feasibility | 15% | 13% | Measured sanitized fixtures cover native/noarch Conda, failing CI, successful/failing documentation and npm release workflows, cancellation, expired logs, and paired reruns; timed-out, restricted-token, active-transition, and Zenodo evidence remain |
| Phase 1: generic CLI | 30% | 27% | Capture, strict validated replay, formal bundle/model/report schemas, source-referenced normalization, bounded reports, attempt-specific historical truth, outcome exit-code parity, and degraded log analysis are tested; remaining real outcome cases and byte-identical replay timing remain |
...
implementation credit at this checkpoint is **62% toward 1.0**. This is not a schedule
