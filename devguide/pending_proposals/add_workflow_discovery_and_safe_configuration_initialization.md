...
**Status:** Open; the first local, non-overwriting vertical slice is being specified.
...
Classification quality, generated byte size, and runtime remain unmeasured until the
implementation is exercised against both clients.
...
Initial inspection: Linux host, Python 3.13.5, gh-run-receptor source after tag `0.7.0`,
2026-09-05. Final measurements will record the exact commit and commands.
